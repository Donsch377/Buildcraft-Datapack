...
execute if score @s bc_inserted matches 1 if score @s bc_item_count matches 2.. run scoreboard players remove @s bc_item_count 1
execute if score @s bc_inserted matches 1 if score @s bc_item_count matches 2.. run execute store result entity @s Item.count int 1 run scoreboard players get @s bc_item_count
execute if score @s bc_inserted matches 1 if score @s bc_item_count matches 1 run kill @s
