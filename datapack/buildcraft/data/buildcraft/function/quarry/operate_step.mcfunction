...
execute as @e[type=minecraft:item,tag=buildcraft.routed,tag=!buildcraft.route_cooldown,distance=..3] at @e[type=minecraft:marker,tag=buildcraft.quarry,sort=nearest,limit=1,distance=..512] run function buildcraft:quarry/route_item
