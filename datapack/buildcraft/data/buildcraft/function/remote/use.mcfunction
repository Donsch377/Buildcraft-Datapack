...
execute if entity @e[type=minecraft:marker,tag=buildcraft.quarry,distance=..3,sort=nearest,limit=1] as @e[type=minecraft:marker,tag=buildcraft.quarry,distance=..3,sort=nearest,limit=1] at @s run function buildcraft:remote/on_quarry
